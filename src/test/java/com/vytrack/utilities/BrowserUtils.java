...
public class BrowserUtils {
    ...
    public static List<String> getTextFromWebElements(List<WebElement> x){
        List<String> allElementTexts = new ArrayList<>();
        for (WebElement each: x){
            if(!each.getText().isEmpty()) {
                allElementTexts.add(each.getText());
            }
        }
